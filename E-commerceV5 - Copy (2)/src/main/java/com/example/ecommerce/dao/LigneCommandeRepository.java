...
public interface LigneCommandeRepository extends JpaRepository<LigneCommande, Long>{
	...
	@Query("select lc from LigneCommande lc where lc.id = :c")
	public LigneCommande findByIdLCMD(@Param("c")Long id);
	 
	@Query("select lc1 from LigneCommande lc1 where lc1.panier.idPanier = :z AND lc1.produit.idProduit = :t")
	public LigneCommande findByProduitPanier(@Param("t")Long iDProduit,@Param("z") Long idPanier);
