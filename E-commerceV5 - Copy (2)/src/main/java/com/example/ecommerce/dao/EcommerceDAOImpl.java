...
public class EcommerceDAOImpl implements IEcommerceDAO {
	...
	*/
	...
	@Override
	public LigneCommande getByCartAndProduct(Long idpanier, Long IDProduit) {
		// TODO Auto-generated method stub
		return ligneCommandeRepository.findByProduitPanier(IDProduit,idpanier);
	}
	...
	public LigneCommande findById(Long id) {
		// 
		return ligneCommandeRepository.findByIdLCMD(id);
	}
