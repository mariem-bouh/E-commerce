...
//contient la liste de toute les methodes
	...
	public boolean AjouterLigneCMD(LigneCommande ligneCommande) {
		dao.AjouterLigneCMD(ligneCommande);
		return false;
	}
	...
	public boolean SupprimerLigneCMD(Long idligneCommande) {
		// TODO Auto-generated method stub
		dao.SupprimerLigneCMD(idligneCommande);
		return true;
	}
	...
	@Override
	public LigneCommande getByCartAndProduct(Long panier, Long IDProduit) {
		// TODO Auto-generated method stub
		return dao.getByCartAndProduct(panier, IDProduit);
	}
	...
	public Panier ModifTotalPanier(Panier panier) {
		...
		return dao.ModifTotalPanier(panier);
	}
